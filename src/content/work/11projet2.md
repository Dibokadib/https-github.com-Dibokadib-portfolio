...
On considère un bâtiment représenté en Figure 1 dont on souhaite étudier la réponse à un séisme. La modélisation de ce bâtiment a déjà été réalisée dans $Cast3M$,

**Modélisation du bâtiment**:
![Vue 3D du bâtiment](/assets/batiment.png)
...
![Repère local](/assets/section.png)

Ainsi les poutres seront plutôt orientées comme la poutre de type 1 de la figure suivante:

![Poutre de type 1](/assets/poutvert.png)
![Poutre de type 2](/assets/pouthory.png)
...
- Les neuf poteaux sont encastrés au sol à leurs extrémités droites.
```gibiane
